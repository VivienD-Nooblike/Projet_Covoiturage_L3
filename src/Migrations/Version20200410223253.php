 ...
 */
final class Version20200410223253 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Covoiturage (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, trajet_id INTEGER DEFAULT NULL, commentaire_id INTEGER DEFAULT NULL, date_depart DATE NOT NULL, date_arrivee DATE NOT NULL, passager CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:array)
        , description VARCHAR(255) DEFAULT NULL COLLATE BINARY, nb_place INTEGER NOT NULL, prix INTEGER NOT NULL, disponibilite BOOLEAN NOT NULL, date_creation DATE NOT NULL, date_modification DATE NOT NULL, date_expiration DATE NOT NULL, slug VARCHAR(128) NOT NULL, CONSTRAINT FK_AE5B115ED12A823 FOREIGN KEY (trajet_id) REFERENCES trajet (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_AE5B115EBA9CD190 FOREIGN KEY (commentaire_id) REFERENCES Commentaire (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_AE5B115E989D9B62 ON Covoiturage (slug)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_AE5B115E989D9B62');
        $this->addSql('DROP INDEX IDX_AE5B115ED12A823');
        $this->addSql('DROP INDEX IDX_AE5B115EBA9CD190');
        $this->addSql('CREATE TEMPORARY TABLE __temp__Covoiturage AS SELECT id, trajet_id, commentaire_id, date_depart, date_arrivee, passager, description, nb_place, prix, disponibilite, date_creation, date_modification, date_expiration FROM Covoiturage');
        $this->addSql('DROP TABLE Covoiturage');
